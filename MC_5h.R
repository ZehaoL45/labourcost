...
density_qin_personday_5h <- density(data_df_5h$qin_personday, na.rm = TRUE)
density_han_personday_5h <- density(data_df_5h$han_personday, na.rm = TRUE)

density_qin_workforce_5h <- density(data_df_5h$qin_workforce, na.rm = TRUE)
density_han_n_workforce_5h <- density(data_df_5h$han_n_workforce, na.rm = TRUE)
density_han_s_workforce_5h <- density(data_df_5h$han_s_workforce, na.rm = TRUE)
density_han_ns_workforce_5h <- density(data_df_5h$han_ns_workforce, na.rm = TRUE)

density_qin_carthauler_5h <- density(data_df_5h$qin_carthauler, na.rm = TRUE)
density_han_n_carthauler_5h <- density(data_df_5h$han_n_carthauler, na.rm = TRUE)
density_han_s_carthauler_5h <- density(data_df_5h$han_s_carthauler, na.rm = TRUE)
density_han_ns_carthauler_5h <- density(data_df_5h$han_ns_carthauler, na.rm = TRUE)

density_qin_carthauler_personday_5h <- density(data_df_5h$qin_carthauler_personday, na.rm = TRUE)
density_han_carthauler_personday_5h <- density(data_df_5h$han_carthauler_personday, na.rm = TRUE)
